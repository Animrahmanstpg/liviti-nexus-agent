        ...
        <div className="relative overflow-hidden rounded-2xl shadow-xl">
          ...
          <div className="relative px-8 py-16 md:py-20 lg:py-24">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button size="lg" variant="outline" className="bg-primary-foreground/10 border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/20 hover:text-primary-foreground" asChild>
